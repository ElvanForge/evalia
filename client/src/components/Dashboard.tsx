...
export default function Dashboard({ currentUser }: DashboardProps) {
  ...
  return (
    <div>
      {/* Welcome Header */}
      <div className="mb-6 bg-gradient-to-r from-[#8dd9d2] to-[#0ba2b0] dark:from-sky-950 dark:to-blue-950 p-6 rounded-xl shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold text-white mb-1">Hello, {currentUser?.firstName || 'Teacher'}!</h2>
            <p className="text-white dark:text-slate-300">{currentDate} • Welcome to Your Evalia Dashboard</p>
          </div>
      ...
      {/* Tools Section - Moved directly after Classes section */}
      <div className="mb-8">
        <div className="bg-gradient-to-r from-[#8dd9d2] to-[#0ba2b0] text-white font-medium p-3 rounded-t-lg mb-4">
          <h3 className="text-xl font-semibold flex items-center">
            <span className="inline-block mr-2">
