- [Home](https://firefox-source-docs.mozilla.org/index.html)
- Scroll-linked effects
- [Report an issue](https://bugzilla.mozilla.org/enter_bug.cgi?product=Developer+Infrastructure&component=Firefox+Source+Docs%3A+Content&short_desc=Documentation+issue+on+performance/scroll-linked_effects&comment=URL+=+https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html&bug_file_loc=https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html)
/
[View page source](https://firefox-source-docs.mozilla.org/_sources/performance/scroll-linked_effects.md.txt)

* * *

# Scroll-linked effects [](https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html\#scroll-linked-effects "Link to this heading")
...
## Scrolling effects explained [](https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html\#scrolling-effects-explained "Link to this heading")
...
### Example 1: Sticky positioning [](https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html\#example-1-sticky-positioning "Link to this heading")
...
### Example 2: Scroll snapping [](https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html\#example-2-scroll-snapping "Link to this heading")
...
### Other effects [](https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html\#other-effects "Link to this heading")
...
## Future improvements [](https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html\#future-improvements "Link to this heading")
...
### Call to action [](https://firefox-source-docs.mozilla.org/performance/scroll-linked_effects.html\#call-to-action "Link to this heading")
